...
<var onbeforepaste="alert(1)" contenteditable>test</var>
    ...
    <script type="module" id="qwe">if (document.body.addEventListener("load", (t => { t.target.classList.contains("interactive") && t.target.setAttribute("data-readystate", "complete") }), { capture: !0 }), window && document.documentElement) { const t = { light: "#ffffff", dark: "#1b1b1b" }; try { const e = window.localStorage.getItem("theme"); e && (document.documentElement.className = e, document.documentElement.style.backgroundColor = t[e]) } catch (t) { console.warn("Unable to read theme from localStorage", t) } }</script>
    ...
    <div id="root">
        ...
        <div class="page-wrapper  category-api document-page">
            <div class="top-banner loading">
                <section class="place top container"></section>
            </div>
      ...
      ">
                    <div class="container ">
                        <div class="top-navigation-wrap"><a href="/en-US/" class="logo" aria-label="MDN homepage"><svg
                                    id="mdn-docs-logo" xmlns="http://www.w3.org/2000/svg" x="0" y="0"
                                    viewBox="0 0 694.9 104.4" style="enable-background:new 0 0 694.9 104.4"
                                ...
                                </svg></a><button title="Open main menu" type="button"
                                class="button action has-icon main-menu-toggle" aria-haspopup="menu"
                                aria-label="Open main menu" aria-expanded="false"><span class="button-wrap"><span
                                        class="icon icon-menu "></span><span class="visually-hidden">Open main
                                        menu</span></span></button></div>
                        <div class="top-navigation-main">
                            <nav class="main-nav" aria-label="Main menu">
                                <ul class="main-menu nojs">
                                    <li class="top-level-entry-container active"><button type="button"
                                            id="references-button" class="top-level-entry menu-toggle"
                                            aria-controls="references-menu" aria-expanded="false">References</button><a
                                            href="/en-US/docs/Web" class="top-level-entry">References</a>
                                        <ul id="references-menu" class="submenu references hidden inline-submenu-lg"
                                            aria-labelledby="references-button">
                                            <li class="apis-link-container mobile-only "><a href="/en-US/docs/Web"
                                                    class="submenu-item ">
                                                    <div class="submenu-icon"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">Overview / Web Technology
                                                        </div>
                                                        <p class="submenu-item-description">Web technology reference for
                                                            developers</p>
                                                    </div>
                                                </a></li>
                                            <li class="html-link-container "><a href="/en-US/docs/Web/HTML"
                                                    class="submenu-item ">
                                                    <div class="submenu-icon html"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">HTML</div>
                                                        <p class="submenu-item-description">Structure of content on the
                                                            web</p>
                                                    </div>
                                                </a></li>
                                            <li class="css-link-container "><a href="/en-US/docs/Web/CSS"
                                                    class="submenu-item ">
                                                    <div class="submenu-icon css"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">CSS</div>
                                                        <p class="submenu-item-description">Code used to describe
                                                            document style</p>
                                                    </div>
                                                </a></li>
                                            <li class="javascript-link-container "><a href="/en-US/docs/Web/JavaScript"
                                                    class="submenu-item ">
                                                    <div class="submenu-icon javascript"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">JavaScript</div>
                                                        <p class="submenu-item-description">General-purpose scripting
                                                            language</p>
                                                    </div>
                                                </a></li>
                                            <li class="http-link-container "><a href="/en-US/docs/Web/HTTP"
                                                    class="submenu-item ">
                                                    <div class="submenu-icon http"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">HTTP</div>
                                                        <p class="submenu-item-description">Protocol for transmitting
                                                            web resources</p>
                                                    </div>
                                                </a></li>
                                            <li class="apis-link-container "><a href="/en-US/docs/Web/API"
                                                    class="submenu-item ">
                                                    <div class="submenu-icon apis"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">Web APIs</div>
                                                        <p class="submenu-item-description">Interfaces for building web
                                                            applications</p>
                                                    </div>
                                                </a></li>
                                            <li class="apis-link-container "><a
                                                    href="/en-US/docs/Mozilla/Add-ons/WebExtensions"
                                                    class="submenu-item ">
                                                    <div class="submenu-icon"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">Web Extensions</div>
                                                        <p class="submenu-item-description">Developing extensions for
                                                            web browsers</p>
                                                    </div>
                                                </a></li>
                                            <li class="apis-link-container desktop-only "><a href="/en-US/docs/Web"
                                                    class="submenu-item ">
                                                    <div class="submenu-icon"></div>
                                                    <div class="submenu-content-container">
                                    ...
                                    <li class="top-level-entry-container "><button type="button" id="guides-button"
                                            class="top-level-entry menu-toggle" aria-controls="guides-menu"
                                            aria-expanded="false">Guides</button><a href="/en-US/docs/Learn"
                                            class="top-level-entry">Guides</a>
                                        <ul id="guides-menu" class="submenu guides hidden inline-submenu-lg"
                                            aria-labelledby="guides-button">
                                            <li class="apis-link-container mobile-only "><a href="/en-US/docs/Learn"
                                                    class="submenu-item ">
                                                    <div class="submenu-icon learn"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">Overview / MDN Learning Area
                                                        </div>
                                                        <p class="submenu-item-description">Learn web development</p>
                                                    </div>
                                                </a></li>
                                            <li class="apis-link-container desktop-only "><a href="/en-US/docs/Learn"
                                                    class="submenu-item ">
                                                    <div class="submenu-icon learn"></div>
                                                    <div class="submenu-content-container">
                                            ...
                                            <li class="html-link-container "><a href="/en-US/docs/Learn/HTML"
                                                    class="submenu-item ">
                                                    <div class="submenu-icon html"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">HTML</div>
                                                        <p class="submenu-item-description">Learn to structure web
                                                            content with HTML</p>
                                                    </div>
                                                </a></li>
                                            <li class="css-link-container "><a href="/en-US/docs/Learn/CSS"
                                                    class="submenu-item ">
                                                    <div class="submenu-icon css"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">CSS</div>
                                                        <p class="submenu-item-description">Learn to style content using
                                                            CSS</p>
                                                    </div>
                                                </a></li>
                                            <li class="javascript-link-container "><a
                                                    href="/en-US/docs/Learn/JavaScript" class="submenu-item ">
                                                    <div class="submenu-icon javascript"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">JavaScript</div>
                                                        <p class="submenu-item-description">Learn to run scripts in the
                                                            browser</p>
                                                    </div>
                                                </a></li>
                                            <li class=" "><a href="/en-US/docs/Web/Accessibility" class="submenu-item ">
                                                    <div class="submenu-icon"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">Accessibility</div>
                                                        <p class="submenu-item-description">Learn to make the web
                                                            accessible to all</p>
                                                    </div>
                                                </a></li>
                                        </ul>
                                    </li>
                                    <li class="top-level-entry-container "><button type="button" id="mdn-plus-button"
                                            class="top-level-entry menu-toggle" aria-controls="mdn-plus-menu"
                                            aria-expanded="false">Plus</button><a href="/en-US/plus"
                                            class="top-level-entry">Plus</a>
                                        <ul id="mdn-plus-menu" class="submenu mdn-plus hidden inline-submenu-lg"
                                            aria-labelledby="mdn-plus-button">
                                            <li class=" "><a href="/en-US/plus" class="submenu-item ">
                                                    <div class="submenu-icon"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">Overview</div>
                                                        <p class="submenu-item-description">A customized MDN experience
                                                        </p>
                                                    </div>
                                                </a></li>
                                            <li class=" "><a href="/en-US/plus/ai-help" class="submenu-item ">
                                                    <div class="submenu-icon"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">AI Help (beta)</div>
                                                        <p class="submenu-item-description">Get real-time assistance and
                                                            support</p>
                                                    </div>
                                                </a></li>
                                            <li class=" "><a href="/en-US/plus/updates" class="submenu-item ">
                                                    <div class="submenu-icon"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">Updates</div>
                                                        <p class="submenu-item-description">All browser compatibility
                                                            updates at a glance</p>
                                                    </div>
                                                </a></li>
                                            <li class=" "><a href="/en-US/plus/docs/features/overview"
                                                    class="submenu-item ">
                                                    <div class="submenu-icon"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">Documentation</div>
                                                        <p class="submenu-item-description">Learn how to use MDN Plus
                                                        </p>
                                                    </div>
                                                </a></li>
                                            <li class=" "><a href="/en-US/plus/docs/faq" class="submenu-item ">
                                                    <div class="submenu-icon"></div>
                                                    <div class="submenu-content-container">
                                                        <div class="submenu-item-heading">FAQ</div>
                                                        <p class="submenu-item-description">Frequently asked questions
                                                            about MDN Plus</p>
                                                    </div>
                                                </a></li>
                                        </ul>
                                    </li>
                                    <li class="top-level-entry-container "><a class="top-level-entry menu-link"
                                            href="/en-US/blog/">Blog</a></li>
                                    <li class="top-level-entry-container "><a class="top-level-entry menu-link"
                                            href="/en-US/play">Play</a></li>
                                    <li class="top-level-entry-container "><a class="top-level-entry menu-link"
                                            href="/en-US/plus/ai-help">AI Help <sup class="new beta">Beta</sup></a></li>
                                </ul>
                            </nav>
                            <div class="header-search">
                                <form action="/en-US/search" class="search-form search-widget" id="top-nav-search-form"
                                    role="search"><label id="top-nav-search-label" for="top-nav-search-input"
                                        class="visually-hidden">Search MDN</label><input aria-activedescendant=""
                                        aria-autocomplete="list" aria-controls="top-nav-search-menu"
                                        aria-expanded="false" aria-labelledby="top-nav-search-label" autoComplete="off"
                                        id="top-nav-search-input" role="combobox" type="search"
                                        class="search-input-field" name="q" placeholder="   " required=""
                                        value="" /><button type="button"
                                        class="button action has-icon clear-search-button"><span
                                            class="button-wrap"><span class="icon icon-cancel "></span><span
                                                class="visually-hidden">Clear search input</span></span></button><button
                                        type="submit" class="button action has-icon search-button"><span
                                            class="button-wrap"><span class="icon icon-search "></span><span
                                                class="visually-hidden">Search</span></span></button>
                                    <div id="top-nav-search-menu" role="listbox" aria-labelledby="top-nav-search-label">
                                    </div>
                                </form>
                            </div>
                            <div class="theme-switcher-menu"><button type="button"
                                    class="button action has-icon theme-switcher-menu small" aria-haspopup="menu"><span
                                        class="button-wrap"><span
                                            class="icon icon-theme-os-default "></span>Theme</span></button></div>
                            <ul class="auth-container">
                                <li><a href="/users/fxa/login/authenticate/?next=%2Fen-US%2Fdocs%2FWeb%2FAPI%2FElement%2FremoveAttribute"
                                        class="login-link" rel="nofollow">Log in</a></li>
                                <li><a href="/users/fxa/login/authenticate/?next=%2Fen-US%2Fdocs%2FWeb%2FAPI%2FElement%2FremoveAttribute"
                                        target="_self" class="button primary mdn-plus-subscribe-link"><span
                                            class="button-wrap">Sign up for free</span></a></li>
                            </ul>
                        </div>
                    </div>
                </header>
                <div class="article-actions-container">
                    <div class="container"><button type="button" class="button action has-icon sidebar-button"
                            aria-label="Expand sidebar" aria-expanded="false" aria-controls="sidebar-quicklinks"><span
                                class="button-wrap"><span class="icon icon-sidebar "></span></span></button>
                        <nav class="breadcrumbs-container" aria-label="Breadcrumb">
                            <ol typeof="BreadcrumbList" vocab="https://schema.org/" aria-label="breadcrumbs">
                                <li property="itemListElement" typeof="ListItem"><a class="breadcrumb" property="item"
                                        typeof="WebPage" href="/en-US/docs/Web"><span
                                            property="name">References</span></a>
                                    <meta property="position" content="1" />
                                </li>
                                <li property="itemListElement" typeof="ListItem"><a class="breadcrumb" property="item"
                                        typeof="WebPage" href="/en-US/docs/Web/API"><span property="name">Web
                                            APIs</span></a>
                                    <meta property="position" content="2" />
                                </li>
                                <li property="itemListElement" typeof="ListItem"><a class="breadcrumb" property="item"
                                        typeof="WebPage" href="/en-US/docs/Web/API/Element"><span
                                            property="name">Element</span></a>
                                    <meta property="position" content="3" />
                                </li>
                                <li property="itemListElement" typeof="ListItem"><a class="breadcrumb-current-page"
                                        property="item" typeof="WebPage"
                                        href="/en-US/docs/Web/API/Element/removeAttribute"><span
                                            property="name">removeAttribute()</span></a>
                                    <meta property="position" content="4" />
                                </li>
                            </ol>
                        </nav>
                        <div class="article-actions"><button type="button"
                                class="button action has-icon article-actions-toggle" aria-label="Article actions"><span
                                    class="button-wrap"><span class="icon icon-ellipses "></span><span
                                        class="article-actions-dialog-heading">Article Actions</span></span></button>
                            <ul class="article-actions-entries">
                                <li class="article-actions-entry">
                                    <div class="languages-switcher-menu open-on-focus-within"><button
                                            id="languages-switcher-button" type="button"
                                            class="button action small has-icon languages-switcher-menu"
                                            aria-haspopup="menu"><span class="button-wrap"><span
                                                    class="icon icon-language "></span>English (US)</span></button>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="main-wrapper">
                <div class="sidebar-container">
                    <aside id="sidebar-quicklinks" class="sidebar" data-macro="APIRef"><button type="button"
                            class="button action backdrop" aria-label="Collapse sidebar"><span
                                class="button-wrap"></span></button>
                        <nav aria-label="Related Topics" class="sidebar-inner">
                            <header class="sidebar-actions">
                                <section class="sidebar-filter-container">
                                    <div class="sidebar-filter "><label id="sidebar-filter-label"
                                            class="sidebar-filter-label" for="sidebar-filter-input"><span
                                                class="icon icon-filter"></span><span class="visually-hidden">Filter
                                                sidebar</span></label><input id="sidebar-filter-input"
                                            autoComplete="off" class="sidebar-filter-input-field false" type="text"
                                            placeholder="Filter" value="" /><button type="button"
                                            class="button action has-icon clear-sidebar-filter-button"><span
                                                class="button-wrap"><span class="icon icon-cancel "></span><span
                                                    class="visually-hidden">Clear filter input</span></span></button>
                                    </div>
                                </section>
                            </header>
                            <div class="sidebar-inner-nav">
                                <div class="in-nav-toc">
                                    <div class="document-toc-container">
                                        <section class="document-toc">
                                            <header>
                                                <h2 class="document-toc-heading">In this article</h2>
                                            </header>
                                            <ul class="document-toc-list">
                                                <li class="document-toc-item "><a class="document-toc-link"
                                                        href="#syntax">Syntax</a></li>
                                                <li class="document-toc-item "><a class="document-toc-link"
                                                        href="#usage_notes">Usage notes</a></li>
                                                <li class="document-toc-item "><a class="document-toc-link"
                                                        href="#examples">Examples</a></li>
                                                <li class="document-toc-item "><a class="document-toc-link"
                                                        href="#specifications">Specifications</a></li>
                                                <li class="document-toc-item "><a class="document-toc-link"
                                                        href="#browser_compatibility">Browser compatibility</a></li>
                                            </ul>
                                        </section>
                                    </div>
                                </div>
                                <div class="sidebar-body">
                                    <ol>
                                        <li><strong><a href="/en-US/docs/Web/API/Document_Object_Model">Document Object
                                                    Model</a></strong></li>
                                        <li><strong><a
                                                    href="/en-US/docs/Web/API/Element"><code>Element</code></a></strong>
                                        </li>
                                        <li class="toggle">
                                            <details open="">
                                                ...
                                                <ol>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaAtomic"><code>ariaAtomic</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaAutoComplete"><code>ariaAutoComplete</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaBusy"><code>ariaBusy</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaChecked"><code>ariaChecked</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaColCount"><code>ariaColCount</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaColIndex"><code>ariaColIndex</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaColIndexText"><code>ariaColIndexText</code></a><abbr
                                                            class="icon icon-experimental"
                                                            title="Experimental. Expect behavior to change in the future.">
                                                            <span class="visually-hidden">Experimental</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaColSpan"><code>ariaColSpan</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaCurrent"><code>ariaCurrent</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaDescription"><code>ariaDescription</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaDisabled"><code>ariaDisabled</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaExpanded"><code>ariaExpanded</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaHasPopup"><code>ariaHasPopup</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaHidden"><code>ariaHidden</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaKeyShortcuts"><code>ariaKeyShortcuts</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaLabel"><code>ariaLabel</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaLevel"><code>ariaLevel</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaLive"><code>ariaLive</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaModal"><code>ariaModal</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaMultiLine"><code>ariaMultiLine</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaMultiSelectable"><code>ariaMultiSelectable</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaOrientation"><code>ariaOrientation</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaPlaceholder"><code>ariaPlaceholder</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaPosInSet"><code>ariaPosInSet</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaPressed"><code>ariaPressed</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaReadOnly"><code>ariaReadOnly</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaRelevant"><code>ariaRelevant</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaRequired"><code>ariaRequired</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaRoleDescription"><code>ariaRoleDescription</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaRowCount"><code>ariaRowCount</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaRowIndex"><code>ariaRowIndex</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaRowIndexText"><code>ariaRowIndexText</code></a><abbr
                                                            class="icon icon-experimental"
                                                            title="Experimental. Expect behavior to change in the future.">
                                                            <span class="visually-hidden">Experimental</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaRowSpan"><code>ariaRowSpan</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaSelected"><code>ariaSelected</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaSetSize"><code>ariaSetSize</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaSort"><code>ariaSort</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaValueMax"><code>ariaValueMax</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaValueMin"><code>ariaValueMin</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaValueNow"><code>ariaValueNow</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/ariaValueText"><code>ariaValueText</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/assignedSlot"><code>assignedSlot</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/attributes"><code>attributes</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/childElementCount"><code>childElementCount</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/children"><code>children</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/classList"><code>classList</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/className"><code>className</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/clientHeight"><code>clientHeight</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/clientLeft"><code>clientLeft</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/clientTop"><code>clientTop</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/clientWidth"><code>clientWidth</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/elementTiming"><code>elementTiming</code></a><abbr
                                                            class="icon icon-experimental"
                                                            title="Experimental. Expect behavior to change in the future.">
                                                            <span class="visually-hidden">Experimental</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/firstElementChild"><code>firstElementChild</code></a>
                                                    </li>
                                                    <li><a href="/en-US/docs/Web/API/Element/id"><code>id</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/innerHTML"><code>innerHTML</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/lastElementChild"><code>lastElementChild</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/localName"><code>localName</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/namespaceURI"><code>namespaceURI</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/nextElementSibling"><code>nextElementSibling</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/outerHTML"><code>outerHTML</code></a>
                                                    </li>
                                                    <li><a href="/en-US/docs/Web/API/Element/part"><code>part</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/prefix"><code>prefix</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/previousElementSibling"><code>previousElementSibling</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/scrollHeight"><code>scrollHeight</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/scrollLeft"><code>scrollLeft</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/scrollLeftMax"><code>scrollLeftMax</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/scrollTop"><code>scrollTop</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/scrollTopMax"><code>scrollTopMax</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/scrollWidth"><code>scrollWidth</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/shadowRoot"><code>shadowRoot</code></a>
                                                    </li>
                                                    <li><a href="/en-US/docs/Web/API/Element/slot"><code>slot</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/tagName"><code>tagName</code></a>
                                                    </li>
                                                </ol>
                                            </details>
                                        </li>
                                        <li class="toggle">
                                            <details open="">
                                                ...
                                                <ol>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/after"><code>after()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/animate"><code>animate()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/append"><code>append()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/attachShadow"><code>attachShadow()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/before"><code>before()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/checkVisibility"><code>checkVisibility()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/closest"><code>closest()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/computedStyleMap"><code>computedStyleMap()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/getAnimations"><code>getAnimations()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/getAttribute"><code>getAttribute()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/getAttributeNames"><code>getAttributeNames()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/getAttributeNode"><code>getAttributeNode()</code></a>
                                                    </li>
                                                    <li><a
                                                    ...
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/getBoundingClientRect"><code>getBoundingClientRect()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/getClientRects"><code>getClientRects()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/getElementsByClassName"><code>getElementsByClassName()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/getElementsByTagName"><code>getElementsByTagName()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/getElementsByTagNameNS"><code>getElementsByTagNameNS()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/hasAttribute"><code>hasAttribute()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/hasAttributeNS"><code>hasAttributeNS()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/hasAttributes"><code>hasAttributes()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/hasPointerCapture"><code>hasPointerCapture()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/insertAdjacentElement"><code>insertAdjacentElement()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/insertAdjacentHTML"><code>insertAdjacentHTML()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/insertAdjacentText"><code>insertAdjacentText()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/matches"><code>matches()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/prepend"><code>prepend()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/querySelector"><code>querySelector()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/querySelectorAll"><code>querySelectorAll()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/releasePointerCapture"><code>releasePointerCapture()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/remove"><code>remove()</code></a>
                                                    </li>
                                                    <li><em><code>removeAttribute()</code> </em></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/removeAttributeNode"><code>removeAttributeNode()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/removeAttributeNS"><code>removeAttributeNS()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/replaceChildren"><code>replaceChildren()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/replaceWith"><code>replaceWith()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/requestFullscreen"><code>requestFullscreen()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/requestPointerLock"><code>requestPointerLock()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/scroll"><code>scroll()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/scrollBy"><code>scrollBy()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/scrollIntoView"><code>scrollIntoView()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/scrollIntoViewIfNeeded"><code>scrollIntoViewIfNeeded()</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/scrollTo"><code>scrollTo()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/setAttribute"><code>setAttribute()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/setAttributeNode"><code>setAttributeNode()</code></a>
                                                    </li>
                                                    <li><a
                                                    ...
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/setCapture"><code>setCapture()</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr><abbr class="icon icon-deprecated"
                                                            title="Deprecated. Not for use in new websites.">
                                                            <span class="visually-hidden">Deprecated</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/setHTML"><code>setHTML()</code></a><abbr
                                                            class="icon icon-experimental"
                                                            title="Experimental. Expect behavior to change in the future.">
                                                            <span class="visually-hidden">Experimental</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/setPointerCapture"><code>setPointerCapture()</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/toggleAttribute"><code>toggleAttribute()</code></a>
                                                    </li>
                                                </ol>
                                            </details>
                                        </li>
                                        <li class="toggle">
                                            <details open="">
                                                ...
                                                <ol>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/afterscriptexecute_event"><code>afterscriptexecute</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/animationcancel_event"><code>animationcancel</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/animationend_event"><code>animationend</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/animationiteration_event"><code>animationiteration</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/animationstart_event"><code>animationstart</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/auxclick_event"><code>auxclick</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/beforeinput_event"><code>beforeinput</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/beforematch_event"><code>beforematch</code></a><abbr
                                                            class="icon icon-experimental"
                                                            title="Experimental. Expect behavior to change in the future.">
                                                            <span class="visually-hidden">Experimental</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/beforescriptexecute_event"><code>beforescriptexecute</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/beforexrselect_event"><code>beforexrselect</code></a><abbr
                                                            class="icon icon-experimental"
                                                            title="Experimental. Expect behavior to change in the future.">
                                                            <span class="visually-hidden">Experimental</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/blur_event"><code>blur</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/click_event"><code>click</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/compositionend_event"><code>compositionend</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/compositionstart_event"><code>compositionstart</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/compositionupdate_event"><code>compositionupdate</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/contentvisibilityautostatechange_event"><code>contentvisibilityautostatechange</code></a><abbr
                                                            class="icon icon-experimental"
                                                            title="Experimental. Expect behavior to change in the future.">
                                                            <span class="visually-hidden">Experimental</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/contextmenu_event"><code>contextmenu</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/copy_event"><code>copy</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/cut_event"><code>cut</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/dblclick_event"><code>dblclick</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/DOMActivate_event"><code>DOMActivate</code></a><abbr
                                                            class="icon icon-deprecated"
                                                            title="Deprecated. Not for use in new websites.">
                                                            <span class="visually-hidden">Deprecated</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/DOMMouseScroll_event"><code>DOMMouseScroll</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr><abbr class="icon icon-deprecated"
                                                    ...
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/focus_event"><code>focus</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/focusin_event"><code>focusin</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/focusout_event"><code>focusout</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/fullscreenchange_event"><code>fullscreenchange</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/fullscreenerror_event"><code>fullscreenerror</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/gesturechange_event"><code>gesturechange</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/gestureend_event"><code>gestureend</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/gesturestart_event"><code>gesturestart</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/gotpointercapture_event"><code>gotpointercapture</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/input_event"><code>input</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/keydown_event"><code>keydown</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/keypress_event"><code>keypress</code></a><abbr
                                                            class="icon icon-deprecated"
                                                            title="Deprecated. Not for use in new websites.">
                                                            <span class="visually-hidden">Deprecated</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/keyup_event"><code>keyup</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/lostpointercapture_event"><code>lostpointercapture</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/mousedown_event"><code>mousedown</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/mouseenter_event"><code>mouseenter</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/mouseleave_event"><code>mouseleave</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/mousemove_event"><code>mousemove</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/mouseout_event"><code>mouseout</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/mouseover_event"><code>mouseover</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/mouseup_event"><code>mouseup</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/mousewheel_event"><code>mousewheel</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr><abbr class="icon icon-deprecated"
                                                    ...
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/MozMousePixelScroll_event"><code>MozMousePixelScroll</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr><abbr class="icon icon-deprecated"
                                                    ...
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/paste_event"><code>paste</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/pointercancel_event"><code>pointercancel</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/pointerdown_event"><code>pointerdown</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/pointerenter_event"><code>pointerenter</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/pointerleave_event"><code>pointerleave</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/pointermove_event"><code>pointermove</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/pointerout_event"><code>pointerout</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/pointerover_event"><code>pointerover</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/pointerrawupdate_event"><code>pointerrawupdate</code></a><abbr
                                                            class="icon icon-experimental"
                                                            title="Experimental. Expect behavior to change in the future.">
                                                            <span class="visually-hidden">Experimental</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/pointerup_event"><code>pointerup</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/scroll_event"><code>scroll</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/scrollend_event"><code>scrollend</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/securitypolicyviolation_event"><code>securitypolicyviolation</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/touchcancel_event"><code>touchcancel</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/touchend_event"><code>touchend</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/touchmove_event"><code>touchmove</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/touchstart_event"><code>touchstart</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/transitioncancel_event"><code>transitioncancel</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/transitionend_event"><code>transitionend</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/transitionrun_event"><code>transitionrun</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/transitionstart_event"><code>transitionstart</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/webkitmouseforcechanged_event"><code>webkitmouseforcechanged</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/webkitmouseforcedown_event"><code>webkitmouseforcedown</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/webkitmouseforceup_event"><code>webkitmouseforceup</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/webkitmouseforcewillbegin_event"><code>webkitmouseforcewillbegin</code></a><abbr
                                                            class="icon icon-nonstandard"
                                                            title="Non-standard. Check cross-browser support before using.">
                                                            <span class="visually-hidden">Non-standard</span>
                                                        </abbr></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/Element/wheel_event"><code>wheel</code></a>
                                                    </li>
                                                </ol>
                                            </details>
                                        </li>
                                        <li class="toggle">
                                            <details open="">
                                                ...
                                                <ol>
                                                    ...
                                                    <li><a
                                                            href="/en-US/docs/Web/API/EventTarget"><code>EventTarget</code></a>
                                                    </li>
                                                </ol>
                                            </details>
                                        </li>
                                        <li class="toggle">
                                            <details open="">
                                                <summary>Related pages for DOM</summary>
                                                <ol>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/AbortController"><code>AbortController</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/AbortSignal"><code>AbortSignal</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/AbstractRange"><code>AbstractRange</code></a>
                                                    </li>
                                                    <li><a href="/en-US/docs/Web/API/Attr"><code>Attr</code></a></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/CDATASection"><code>CDATASection</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/CharacterData"><code>CharacterData</code></a>
                                                    </li>
                                                    <li><a href="/en-US/docs/Web/API/Comment"><code>Comment</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/CustomEvent"><code>CustomEvent</code></a>
                                                    </li>
                                                    <li><a href="/en-US/docs/Web/API/DOMError"><code>DOMError</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/DOMException"><code>DOMException</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/DOMImplementation"><code>DOMImplementation</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/DOMParser"><code>DOMParser</code></a>
                                                    </li>
                                                    <li><a href="/en-US/docs/Web/API/DOMPoint"><code>DOMPoint</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/DOMPointReadOnly"><code>DOMPointReadOnly</code></a>
                                                    </li>
                                                    <li><a href="/en-US/docs/Web/API/DOMRect"><code>DOMRect</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/DOMTokenList"><code>DOMTokenList</code></a>
                                                    </li>
                                                    <li><a href="/en-US/docs/Web/API/Document"><code>Document</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/DocumentFragment"><code>DocumentFragment</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/DocumentType"><code>DocumentType</code></a>
                                                    </li>
                                                    <li><a href="/en-US/docs/Web/API/Event"><code>Event</code></a></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/EventTarget"><code>EventTarget</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/HTMLCollection"><code>HTMLCollection</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/MutationObserver"><code>MutationObserver</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/MutationRecord"><code>MutationRecord</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/NamedNodeMap"><code>NamedNodeMap</code></a>
                                                    </li>
                                                    <li><a href="/en-US/docs/Web/API/Node"><code>Node</code></a></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/NodeIterator"><code>NodeIterator</code></a>
                                                    </li>
                                                    <li><a href="/en-US/docs/Web/API/NodeList"><code>NodeList</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/ProcessingInstruction"><code>ProcessingInstruction</code></a>
                                                    </li>
                                                    <li><a href="/en-US/docs/Web/API/Range"><code>Range</code></a></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/StaticRange"><code>StaticRange</code></a>
                                                    </li>
                                                    <li><a href="/en-US/docs/Web/API/Text"><code>Text</code></a></li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/TextDecoder"><code>TextDecoder</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/TextEncoder"><code>TextEncoder</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/TimeRanges"><code>TimeRanges</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/TreeWalker"><code>TreeWalker</code></a>
                                                    </li>
                                                    <li><a
                                                            href="/en-US/docs/Web/API/XMLDocument"><code>XMLDocument</code></a>
                                                    </li>
                                                </ol>
                                            </details>
                                        </li>
                ...
                <main id="content" class="main-content  ">
                    <article class="main-page-content" lang="en-US">
                        <header>
                            <h1>Element: removeAttribute() method</h1>
                        </header>
                        <div class="section-content">
                            <p>
                                The <a href="/en-US/docs/Web/API/Element"><code>Element</code></a> method
                            ...
                            <div class="section-content">
                                <div class="code-example">
                                    ...
                                    <pre class="brush: js notranslate"
                                        data-signature="r7OYdBBpRUc1XZQlc321gOdT9gOO1nKK1yO20qP22VQ="><code><span class="token function">removeAttribute</span><span class="token punctuation">(</span>attrName<span class="token punctuation">)</span>
</code></pre>
                                </div>
                            </div>
                        </section>
                        <section aria-labelledby="parameters">
                            ...
                            <div class="section-content">
                                <dl>
                                    <dt id="attrname"><a href="#attrname"><code>attrName</code></a></dt>
                                    <dd>
                                        <p>
                        ...
                        <section aria-labelledby="return_value">
                            <h3 id="return_value"><a href="#return_value">Return value</a></h3>
                            <div class="section-content">
                                <p>None (<a
                                        href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/undefined"><code>undefined</code></a>).
                                </p>
                            </div>
                        </section>
                        <section aria-labelledby="usage_notes">
                            <h2 id="usage_notes"><a href="#usage_notes">Usage notes</a></h2>
                            <div class="section-content">
                                <p>
                                    You should use <code>removeAttribute()</code> instead of setting the attribute value
                                    to
                                    <code>null</code> either directly or using <a
                                        href="/en-US/docs/Web/API/Element/setAttribute"
                                        title="setAttribute()"><code>setAttribute()</code></a>. Many attributes will not
                                    behave as expected if you set them to
                                    <code>null</code>.
                                </p>
                                    ...
                                    <table class="standard-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>DOM Level 1 methods for dealing with <code>Attr</code> nodes
                                                    directly (seldom used)</th>
                                                <th>DOM Level 2 namespace-aware methods for dealing with
                                                    <code>Attr</code> nodes directly (seldom used)</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td><a href="/en-US/docs/Web/API/Element/setAttribute"
                                                        title="setAttribute"><code>setAttribute</code></a> (DOM 1)</td>
                                                <td><a href="/en-US/docs/Web/API/Element/setAttributeNS"
                                                        title="setAttributeNS"><code>setAttributeNS</code></a></td>
                                                <td><a href="/en-US/docs/Web/API/Element/setAttributeNode"
                                                        title="setAttributeNode"><code>setAttributeNode</code></a></td>
                                                <td><a href="/en-US/docs/Web/API/Element/setAttributeNodeNS"
                                                        title="setAttributeNodeNS"><code>setAttributeNodeNS</code></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><a href="/en-US/docs/Web/API/Element/getAttribute"
                                                        title="getAttribute"><code>getAttribute</code></a> (DOM 1)</td>
                                                <td><a href="/en-US/docs/Web/API/Element/getAttributeNS"
                                                        title="getAttributeNS"><code>getAttributeNS</code></a></td>
                                                <td><a href="/en-US/docs/Web/API/Element/getAttributeNode"
                                                        title="getAttributeNode"><code>getAttributeNode</code></a></td>
                                                <td><a href="/en-US/docs/Web/API/Element/getAttributeNodeNS"
                                                        title="getAttributeNodeNS"><code>getAttributeNodeNS</code></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><a href="/en-US/docs/Web/API/Element/hasAttribute"
                                                        title="hasAttribute"><code>hasAttribute</code></a> (DOM 2)</td>
                                                <td><a href="/en-US/docs/Web/API/Element/hasAttributeNS"
                                                        title="hasAttributeNS"><code>hasAttributeNS</code></a></td>
                                                <td>-</td>
                                                <td>-</td>
                                            </tr>
                                            <tr>
                                                <td><a href="/en-US/docs/Web/API/Element/removeAttribute"
                                                        title="removeAttribute"
                                                        aria-current="page"><code>removeAttribute</code></a> (DOM 1)
                                                </td>
                                                <td><a href="/en-US/docs/Web/API/Element/removeAttributeNS"
                                                        title="removeAttributeNS"><code>removeAttributeNS</code></a>
                                                </td>
                                                <td><a href="/en-US/docs/Web/API/Element/removeAttributeNode"
                                                        title="removeAttributeNode"><code>removeAttributeNode</code></a>
                                                </td>
                                                <td>-</td>
                                            </tr>
                                        </tbody>
                        ...
                        <section aria-labelledby="examples">
                            ...
                            <div class="section-content">
                                <div class="code-example">
                                    <div class="example-header"><span class="language-name">js</span></div>
                                    <pre class="brush: js notranslate"
                                        data-signature="AZXewVCsPqFzrniqOxh+qbg5nmCyxhlpEpo5pVYP1M4="><code><span class="token comment">// Given: &lt;div id="div1" disabled width="200px"&gt;</span>
document<span class="token punctuation">.</span><span class="token function">getElementById</span><span class="token punctuation">(</span><span class="token string">"div1"</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">removeAttribute</span><span class="token punctuation">(</span><span class="token string">"disabled"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token comment">// Now: &lt;div id="div1" width="200px"&gt;</span>
</code></pre>
                                </div>
                            </div>
                        </section>
                        ...
                        <table class="standard-table">
                            ...
                            <tbody>
                                <tr>
                                    <td><a href="https://dom.spec.whatwg.org/#ref-for-dom-element-removeattribute①">DOM
                                            Standard<!-- --> <br /><small>#
                                                <!-- -->ref-for-dom-element-removeattribute①</small></a></td>
                                </tr>
                            </tbody>
                        </table>
                        <h2 id="browser_compatibility"><a href="#browser_compatibility">Browser compatibility</a></h2>
                        <p>BCD tables only load in the browser<noscript> <!-- -->with JavaScript enabled. Enable
                                JavaScript to view data.</noscript></p>
                        <aside class="metadata">
                            <div class="metadata-content-container">
                                <div id="on-github" class="on-github">
                                    <h3>Found a content problem with this page?</h3>
                                    <ul>
                                        <li><a href="https://github.com/mdn/content/edit/main/files/en-us/web/api/element/removeattribute/index.md"
                                                title="This will take you to GitHub, where you&#x27;ll need to sign in first."
                                                target="_blank" rel="noopener noreferrer">Edit the page on GitHub</a>.
                                        </li>
                                        <li><a href="https://github.com/mdn/content/issues/new?template=page-report.yml&amp;mdn-url=https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FAPI%2FElement%2FremoveAttribute&amp;metadata=%3C%21--+Do+not+make+changes+below+this+line+--%3E%0A%3Cdetails%3E%0A%3Csummary%3EPage+report+details%3C%2Fsummary%3E%0A%0A*+Folder%3A+%60en-us%2Fweb%2Fapi%2Felement%2Fremoveattribute%60%0A*+MDN+URL%3A+https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FAPI%2FElement%2FremoveAttribute%0A*+GitHub+URL%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fblob%2Fmain%2Ffiles%2Fen-us%2Fweb%2Fapi%2Felement%2Fremoveattribute%2Findex.md%0A*+Last+commit%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fcommit%2F575c1b326f8e58697ad3af69141203ab8c13e97e%0A*+Document+last+modified%3A+2023-10-29T08%3A24%3A16.000Z%0A%0A%3C%2Fdetails%3E"
                                                title="This will take you to GitHub to file a new issue."
                                                target="_blank" rel="noopener noreferrer">Report the content issue</a>.
                                        </li>
                                        <li><a href="https://github.com/mdn/content/blob/main/files/en-us/web/api/element/removeattribute/index.md?plain=1"
                                                title="Folder: en-us/web/api/element/removeattribute (Opens in a new tab)"
                                                target="_blank" rel="noopener noreferrer">View the source on GitHub</a>.
                                        </li>
                                    </ul>Want to get more involved?<!-- --> <a
                                        ...
                                        target="_blank" rel="noopener noreferrer">Learn how to contribute</a>.
                                </div>
                                <p class="last-modified-date">This page was last modified on<!-- --> <time
                                        dateTime="2023-10-29T08:24:16.000Z">Oct 29, 2023</time> by<!-- --> <a
                                        href="/en-US/docs/Web/API/Element/removeAttribute/contributors.txt">MDN
                                        contributors</a>.</p>
                            </div>
                        </aside>
                    </article>
        ...
        <footer id="nav-footer" class="page-footer">
            <div class="page-footer-grid">
                <div class="page-footer-logo-col"><a href="/" class="mdn-footer-logo" aria-label="MDN homepage"><svg
                    ...
                    <ul class="social-icons">
                        <li><a class="icon icon-mastodon" href="https://mozilla.social/@mdn" target="_blank"
                                rel="me noopener noreferrer"><span class="visually-hidden">MDN on Mastodon</span></a>
                        </li>
                        <li><a class="icon icon-twitter" href="https://twitter.com/mozdevnet" target="_blank"
                                rel="noopener noreferrer"><span class="visually-hidden">MDN on Twitter</span></a></li>
                        <li><a class="icon icon-github-mark-small" href="https://github.com/mdn/" target="_blank"
                                rel="noopener noreferrer"><span class="visually-hidden">MDN on GitHub</span></a></li>
                        <li><a class="icon icon-feed" href="/en-US/blog/rss.xml" target="_blank"><span
                                    class="visually-hidden">MDN Blog RSS Feed</span></a></li>
                    </ul>
                </div>
                <div class="page-footer-nav-col-1">
                    ...
                    <ul class="footer-nav-list">
                        ...
                        <li class="footer-nav-item"><a href="/en-US/blog/">Blog</a></li>
                        <li class="footer-nav-item"><a
                                href="https://www.mozilla.org/en-US/careers/listings/?team=ProdOps" target="_blank"
                                rel="noopener noreferrer">Careers</a></li>
                        <li class="footer-nav-item"><a href="/en-US/advertising">Advertise with us</a></li>
                    </ul>
                </div>
                <div class="page-footer-nav-col-2">
                    <h2 class="footer-nav-heading">Support</h2>
                    <ul class="footer-nav-list">
                        <li class="footer-nav-item"><a class="footer-nav-link"
                                href="https://support.mozilla.org/products/mdn-plus">Product help</a></li>
                        <li class="footer-nav-item"><a class="footer-nav-link"
                                href="/en-US/docs/MDN/Community/Issues">Report an issue</a></li>
                    </ul>
                </div>
                <div class="page-footer-nav-col-3">
                    <h2 class="footer-nav-heading">Our communities</h2>
                    <ul class="footer-nav-list">
                        <li class="footer-nav-item"><a class="footer-nav-link" href="/en-US/community">MDN Community</a>
                        </li>
                        <li class="footer-nav-item"><a class="footer-nav-link"
                                href="https://discourse.mozilla.org/c/mdn/236" target="_blank"
                                rel="noopener noreferrer">MDN Forum</a></li>
                        <li class="footer-nav-item"><a class="footer-nav-link" href="/discord" target="_blank"
                                rel="noopener noreferrer">MDN Chat</a></li>
                    </ul>
                </div>
                <div class="page-footer-nav-col-4">
                    <h2 class="footer-nav-heading">Developers</h2>
                    <ul class="footer-nav-list">
                        <li class="footer-nav-item"><a class="footer-nav-link" href="/en-US/docs/Web">Web
                                Technologies</a></li>
                        <li class="footer-nav-item"><a class="footer-nav-link" href="/en-US/docs/Learn">Learn Web
                                Development</a></li>
                        <li class="footer-nav-item"><a class="footer-nav-link" href="/en-US/plus">MDN Plus</a></li>
                        <li class="footer-nav-item"><a href="https://hacks.mozilla.org/" target="_blank"
                                rel="noopener noreferrer">Hacks Blog</a></li>
                    </ul>
                </div>
                <div class="page-footer-moz"><a href="https://www.mozilla.org/" class="footer-moz-logo-link"
                        target="_blank" rel="noopener noreferrer"><svg width="112" height="32" fill="none"
                    ...
                    <ul class="footer-moz-list">
                        <li class="footer-moz-item"><a href="https://www.mozilla.org/privacy/websites/"
                                class="footer-moz-link" target="_blank" rel="noopener noreferrer">Website Privacy
                                Notice</a></li>
                        <li class="footer-moz-item"><a href="https://www.mozilla.org/privacy/websites/#cookies"
                                class="footer-moz-link" target="_blank" rel="noopener noreferrer">Cookies</a></li>
                        <li class="footer-moz-item"><a href="https://www.mozilla.org/about/legal/terms/mozilla"
                                class="footer-moz-link" target="_blank" rel="noopener noreferrer">Legal</a></li>
                        <li class="footer-moz-item"><a
                                href="https://www.mozilla.org/about/governance/policies/participation/"
                                class="footer-moz-link" target="_blank" rel="noopener noreferrer">Community
                                Participation Guidelines</a></li>
                    </ul>
                </div>
                <div class="page-footer-legal">
                    <p id="license" class="page-footer-legal-text">Visit<!-- --> <a href="https://www.mozilla.org"
                            target="_blank" rel="noopener noreferrer">Mozilla Corporation’s</a> <!-- -->not-for-profit
                        parent, the<!-- --> <a target="_blank" rel="noopener noreferrer"
                            href="https://foundation.mozilla.org/">Mozilla Foundation</a>.<br />Portions of this content
                        are ©1998–<!-- -->2024<!-- --> by individual mozilla.org contributors. Content available
                        under<!-- --> <a href="/en-US/docs/MDN/Writing_guidelines/Attrib_copyright_license">a Creative
                            Commons license</a>.</p>
                </div>
            </div>
        </footer>
